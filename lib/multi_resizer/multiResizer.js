...
export class MultiResizer extends BaseResizer {
  ...
  seamImageData(width, height) {
    let seamFactHorizontal = Math.floor(this.binarySearch(width, this.metainfo.widthKeys));
    let seamFactVertical = Math.floor(this.binarySearch(height, this.metainfo.heightKeys));
